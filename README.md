            ...
            <div class="card">Add commentMore actions
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-link" data-bs-toggle="modal" data-bs-target="#modal3">Vejao projeto</button>
                    </div>
                </div>
        ...
        <div class="modal-content">Add commentMore actions
                ...
                <div class="modal-body">
                    <p>O projeto é uma página web criada com HTML e CSS, destinada a exibir uma coleção pessoal de
                        ...
                        seus livros preferidos, fornecendo uma descrição breve de cada um, incluindo o autor, o anoAdd commentMore actions
                ...
                <div class="modal-footer">Add commentMore actions
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-header">Add commentMore actions
                ...
                <div class="modal-body">
                    ...
                    lógicas de jogo, como iniciar o jogo, apresentar perguntas e alternativas, processar as escolhasAdd commentMore actions
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>O projeto é uma aplicação educativa interativa focada em ensinar conceitos básicos de
                        ...
                        cenários para criar uma experiência de aprendizado envolvente. O objetivo é familiarizarAdd commentMore actions
                    ...
                    <p>Cada ator no projeto possui scripts que definem seu comportamento em resposta a eventos
                        ...
                        diálogos informativos. Por exemplo, ao clicar em determinados atores, os usuários podemAdd commentMore actions
                    ...
                    <p>A importância das ferramentas utilizadas, como os blocos de código visual do Scratch,
                        ...
                        experiência de aprendizado mais rica e memorável, encorajando os usuários a explorar eAdd commentMore actions
